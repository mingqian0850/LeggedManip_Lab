...
gym.register(
    id="B2W-Z1-EE-WBC-Stage20-Workspace-Grid-Adaptive-Mirrored-Filter35-Play-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": (
            f"{__name__}.ee_wbc_env_cfg:B2WZ1WorkspaceGridAdaptiveMirroredFilter35EnvCfg_PLAY"
        ),
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:B2WZ1EEWBCFineTunePPORunnerCfg",
    },
)
...
gym.register(
    id="B2W-Z1-EE-WBC-Stage20-Workspace-Sweep-Adaptive-Mirrored-Filter35-Play-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": (
            f"{__name__}.ee_wbc_env_cfg:B2WZ1WorkspaceSweepAdaptiveMirroredFilter35EnvCfg_PLAY"
        ),
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:B2WZ1EEWBCFineTunePPORunnerCfg",
    },
)
...
gym.register(
    id="B2W-Z1-EE-WBC-Stage20b-Wide-Grid-Adaptive-Mirrored-Filter35-Play-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": (
            f"{__name__}.ee_wbc_env_cfg:B2WZ1WideWorkspaceGridAdaptiveMirroredFilter35EnvCfg_PLAY"
        ),
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:B2WZ1EEWBCFineTunePPORunnerCfg",
    },
)
...
gym.register(
    id="B2W-Z1-EE-WBC-Stage20b-Wide-Sweep-Adaptive-Mirrored-Filter35-Play-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": (
            f"{__name__}.ee_wbc_env_cfg:B2WZ1WideWorkspaceSweepAdaptiveMirroredFilter35EnvCfg_PLAY"
        ),
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:B2WZ1EEWBCFineTunePPORunnerCfg",
    },
)
